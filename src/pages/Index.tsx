    ...
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <PipelineBar stages={data.stages} onStageClick={handleStageClick} />
          <StageCards stages={data.stages} highlightedStage={highlightedStage} />
          <ContentTable rows={data.content} />
          <div className="grid grid-cols-2 gap-0">
            <ICPPanel metrics={data.icpMetrics} />
            <LeadMagnetTracker data={data.leadMagnet} />
          </div>
        </main>
      </div>
    </div>
